...
export default async function Home() {
  ...
  return (
    <>
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-neutral-600">
            This is a demonstration site for{' '}
            <a href="https://www.minimalwebshop.com">
              MinimalWebshop - the easiest way to integrate a webshop into any
              CMS
            </a>
            .
          </p>
      ...
      <Container className="mt-12 sm:mt-12 md:mt-24">
        <Shop />
      </Container>
